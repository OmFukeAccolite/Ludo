      ...
      if(chance.val == "p1"){
        if(this.p1.count+random<= 51){
          for (let index = 0; index < random; index++) {
            ...
            if(this.ludoBoard[this.p1.x][this.p1.y].player == null){
